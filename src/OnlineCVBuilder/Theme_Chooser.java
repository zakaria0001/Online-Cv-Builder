 ...
 */
public class Theme_Chooser extends javax.swing.JFrame {

    /**
     * Creates new form Theme_Chooser
     */
    public Theme_Chooser() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jButton4.setText("Business Design");
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
       Theme_Business r  = new Theme_Business();
       r.setVisible(true);
       this.dispose();        
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Theme_Chooser.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Theme_Chooser().setVisible(true);
            }
        });
    }
